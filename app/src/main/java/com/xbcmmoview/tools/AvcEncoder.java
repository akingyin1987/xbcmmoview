...
public class AvcEncoder {
    ...
    public void createfile() {
        ...
        mediaFormat.setInteger(io.vov.vitamio.MediaFormat.KEY_COLOR_FORMAT, this.m_SupportColorFormat);
        mediaFormat.setInteger("bitrate", 4000000);
        mediaFormat.setInteger(io.vov.vitamio.MediaFormat.KEY_FRAME_RATE, 20);
